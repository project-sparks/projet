...
if (isset($_GET['reference'])){
  $abonnementC=new abonnementC();
    $result=$abonnementC->recupererabonnement($_GET['reference']);
...
<form method="POST">
          ...
          <div class="main">
            ...
            <h2>Modifier Abonnement</h2>
              ...
              <input type="number" name="reference" value="<?PHP echo $reference ?>">
            </div>
            
            <div class="txtb">
              <label>Duree de l'abonnement :</label>
...
if (isset($_POST['modifier'])){
  $abonnement=new abonnement($_POST['reference'],$_POST['duree'],$_POST['prix'],$_POST['descr']);
