...
function filterProducts2() {
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="produit.php"> Produits</a></p>
						</div>	
					</div>
				</div>
			</section>
	...
	<input type="button" name="trier" value="trier" onclick="filterProducts2()">
	<br>
	<br>
