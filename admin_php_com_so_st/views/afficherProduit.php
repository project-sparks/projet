...
$(document).ready(function(){
    $('.search').on('keyup',function(){
      ...
      <body> 
           <div >  
                <h3 align="center">statistiques selon la quantité</h3>  
...
<img  class="im1" src= "images/<?PHP echo $row['Image']; ?>" width="50"  height="50">
  ...
  <td><form method="POST" action="supprimerProduit.php">
                                   ...
                                   <a href="#delete<?PHP echo $row['ID_produit'];?>" data-toggle="modal">
                            <button type='button'  name="supprimer" value="supprimer" class='btn btn-danger btn-sm'><i class="fa fa-trash"></i></button>
                        </a>
                         <div id="delete<?PHP echo $row['ID_produit'];?>" class="modal fade" role="dialog">
         ...
         <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="alert alert-danger">Are you Sure you want Delete <strong>
                                                <?php echo $row['LIB_produit']; ?>?</strong> </div>
  ...
  <td><a href="modifierProduit.php?id=<?PHP echo $row['ID_produit']; ?>">
  Modifier</a></td>
  </tr>
  <?PHP
}
...
<A HREF="#" onClick="window.open('historique.php','historique','toolbar=0, location=0, directories=0, status=0, scrollbars=0, resizable=0, copyhistory=0, menuBar=0, width=400, height=300');return(false)">historique</A>
<br>
<br>
</html>
