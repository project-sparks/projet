...
<form method="POST">
          ...
          <div class="main">
            ...
            <div class="txtb">
              <label>Prix :</label>
              <input type="number" name="prix" placeholder="Date" value="<?PHP echo $prix ?>">
            </div>
            ...
            <input type="hidden" name="id_sortie_ini" value="<?PHP echo $_GET['id_sortie'];?>">
          </div>
            </div>
          </div>
</form>
