    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a  class="active" href="produit.php">
              <i class="fa fa-desktop"></i>
              <span>Produit</span>
              </a>
          </li>
...
foreach($listebibs as $row){
  ?>
  <tr >
  <td><?PHP echo $row['id_p']; ?></td>

  <td>
<img  class="im1" src= "images/<?PHP echo $row['image_f']; ?>" width="50"  height="50">
        </td>

  <td>
<img  class="im1" src= "images/<?PHP echo $row['image_s']; ?>" width="50"  height="50">
        </td>

          <td>
<img  class="im1" src= "images/<?PHP echo $row['image_t']; ?>" width="50"  height="50">
        </td>
  <td><form method="POST" action="supprimerbib.php">



                                   <a href="#delete<?PHP echo $row['id_p'];?>" data-toggle="modal">
                            <button type='button'  name="supprimer" value="supprimer" class='btn btn-danger btn-sm'><i class="fa fa-trash"></i></button>
                        </a>
                         <div id="delete<?PHP echo $row['id_p'];?>" class="modal fade" role="dialog">
...
<a href="bib.php"> ajouter un bib</a>
<br>
<div class="imprimer">
