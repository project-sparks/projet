...
<input type="text" name="des"  value="<?PHP echo $Description ?>"></td>
</tr>
<tr>
<td></td>
...
<tr>
<td></td>
<td><input type="hidden" name="LIB_categorie_ini" value="<?PHP echo $_GET['id'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
	...
	$Categorie->modifierCategorie($categorie,$_POST['LIB_categorie_ini']);
