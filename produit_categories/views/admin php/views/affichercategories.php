...
<?php  
 ...
 $query = "SELECT categories.LIB_categorie  as nom, COUNT(LIB_categorie)  AS somme FROM categories GROUP by nom ";  
...
$(document).ready(function(){
    $('.search').on('keyup',function(){
      ...
      <body> 
           <div >  
                <h3 align="center">Les Categories Les Plus Notées</h3>  
...
foreach($listeCategories as $row){
  ...
  <td><form method="POST" action="supprimerCategorie.php">
                                   ...
                                   <a href="#delete<?PHP echo $row['LIB_categorie'];?>" data-toggle="modal">
                            <button type='button'  name="supprimer" value="supprimer" class='btn btn-danger btn-sm'><i class="fa fa-trash"></i></button>
                        </a>
                         <div id="delete<?PHP echo $row['LIB_categorie'];?>" class="modal fade" role="dialog">
        <div class="modal-dialog">
         <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" name="id" value="<?php echo $row['LIB_categorie']; ?>">
                                        <div class="alert alert-danger">Are you Sure you want Delete <strong>
                                                <?php echo $row['LIB_categorie']; ?>?</strong> </div>
  ...
  <td><a href="modifierCategorie.php?id=<?PHP echo $row['idc']; ?>">
  Modifier</a></td>
  </tr>
  <?PHP
}
...
<a href="categories.php"> ajouter un Categories</a>
<br>
<div class="imprimer">
