...
-->
      ...
      <br>
      <br>
      <form method="POST" action="ajouterbib.php">  
            <h2>Formulaire des bib</h2>
            ...
            <p >Importer une image 1 </p>
                <br>
                <input   accept=".jpg, .jpeg, .png" name="image_f" type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                      
            </div>
                        <div class="txtb">
              
            <p style="">Importer une image 2 </p>
                <br>
                <input   accept=".jpg, .jpeg, .png" name="image_s" type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                      
            </div>
                        <div class="txtb">
              
            <p >Importer une image 3 </p>
                <br>
                <input  accept=".jpg, .jpeg, .png" name="image_t" type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
...
$sql="SElECT * From produit";
  ...
  ?>
    ...
    <option value="<?PHP echo $row['ID_produit']; ?>">  <?PHP echo $row['ID_produit']; ?> </option>
  ...
  ?>
            ...
            <a href="afficherbib.php"> affichage </a>
</form> 
            </div>
