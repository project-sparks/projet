			    ...
			    <div class="container">
			    	<div class="row header-top align-items-center">
			    		<div class="col-lg-4 col-sm-4 menu-top-left">
			    			<a href="mailto:<?php echo ($_SESSION['email']); ?>"><span class="lnr lnr-location"></span></a>
			    			<a class="tel" href="mailto:<?php echo ($_SESSION['email']); ?>"><?php echo ($_SESSION['email']); ?></a>
			    		</div>
			    		...
			    		<div class="col-lg-4 col-sm-4 menu-top-right">
			    			<a class="tel" href="logout.php"><?php echo ($_SESSION['prenom']); ?></a>
			    			<a href="logout.php"><span class="lnr lnr-phone-handset"></span></a>
			    		</div>
			    	</div>
			    </div>	
			    	<hr>
			    	...
			    	<div class="row align-items-center justify-content-center d-flex">
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li class="menu-active"><a href="produit.php">Produit</a></li>				          
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="service.html"> Produits</a></p>
						</div>	
					</div>
				</div>
			</section>
...
<div class="container">
	<span class="lnr lnr-arrow-right" >  tri Prix :  	<input type="button" name="trier" value="trier" onclick="filterProducts2()">  </span>
	<br>
	<br>
		<span class="lnr lnr-arrow-right" >  recherche categorie
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-service-page">
								<div class="thumbs relative">
									...
									<img   class="img-fluid" src="images/<?php echo $rows['Image']; ?>" alt="">
								</div>
								<div class="details">
									<a href="#"><h4> Nom : <?php echo $rows['LIB_produit']; ?></h4></a>
	
							<p>
								Quantite : <?php echo $rows['QTE_produit']; ?>
							</p>
							<p>
								prix : <?php echo $rows['Prix']; ?>
							</p>
							<p>
								Categorie : <?php echo $rows['lib_c']; ?>
							</p>
	<p>
									<span class="lnr lnr-arrow-right" >

									<a href="bib.php?id=<?PHP echo $rows['ID_produit']; ?>" >    details   </a>  	  </span>
							</p>
