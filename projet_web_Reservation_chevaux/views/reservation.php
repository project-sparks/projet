				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="reservation.php"> Reservation</a></p>
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="col-md-9 pb-40 header-text text-center">
							<h1 class="pb-10">Reservation d'un cheval</h1>
	...
	?>
						<div class="col-lg-4 col-md-6">
							...
							<div class="single-service-page">
								...
								<div class="details">
									<a href="#"><h4>Nom : <?PHP echo $row['nom']; ?></h4></a>
									<p>
										...
										<br>
										<a href="ajoutReservation.php?id=<?PHP echo $row['idC']; ?>">reserver</a>
