...
<td><?PHP echo $row['sexe']; ?></td>
  ...
  <td><form method="POST" action="supprimercheval.php">
                                   ...
                                   <a href="#delete<?php echo $row['idC']; ?>" data-toggle="modal">
                         ...
                         <div id="delete<?php echo $row['idC']; ?>" class="modal fade" role="dialog">
  ...
  <td><a href="modifierchevals.php?id=<?PHP echo $row['idC']; ?>">
  Modifier</a></td>
  </tr>
  <?PHP
}
