...
$reservation1C=new reservationC();
    ...
    $result=$reservation1C->recupererReservation($_GET['id']);
...
<tr>
<td></td>
<td><input type="hidden" name="idR" value="<?PHP echo $_GET['id'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
	...
	$reservation=new reservation($_POST['date']);
	$reservation1C->modifierReservation($reservation,$_POST['idR']);
