...
<form method="POST" action="ajouterproduit.php">
          ...
          <div class="txtb">
            ...
            <p style="position: absolute;top: 739px;left: 54px;">Importer une image</p>
            <div class="input-group mb-3">
              <div class="custom-file">
                <br>
                <input style="margin-left:210px;" type="file" accept=".jpg, .jpeg, .png" name="image" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
              </div>
            </div>   
...
$sql="SElECT * From categories";
  ...
  ?>
     ...
     <!--<a onclick="verif()" class="btn" id="submit">Envoyez</a>-->
