...
<form method="POST">
          ...
          <div class="main">
            ...
            <div class="txtb">
              <label>LIB Produit :</label>
              <input type="text" name="lib_p"  value="<?PHP echo $lib_p ?>">
            </div>
            ...
            <div class="txtb">
              ...
              <input type="number" name="qte_p" value="<?PHP echo $quantite_p ?>">
            </div>
            ...
            <div class="txtb">
              ...
              <input  id="etat3" type="radio" name="etat" value="epuisé" style="z-index: 1;position: absolute;left: 0px;"/>
              <label for="q0r7" style="z-index: 0;">epuisé</label>
            </div>
      <select  name="lib" >
  <?php
