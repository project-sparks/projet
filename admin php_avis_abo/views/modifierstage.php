...
if (isset($_GET['id_stage'])){
	$stageC=new stageC();
    $result=$stageC->recupererstage($_GET['id_stage']);
...
<form method="POST">
          ...
          <div class="main">
            ...
            <input type="number" name="id_stage" value="<?PHP echo $id_stage ?>" hidden>
            ...
            <div class="txtb">
              ...
              <input type="text" name="formateur" value="<?PHP echo $formateur ?>">
            </div>
            ...
            <input type="hidden" name="id_stage_ini" value="<?PHP echo $_GET['id_stage'];?>">
          </div>
            </div>
          </div>
</form>
...
if (isset($_POST['modifier'])){
	$stage1=new stage($_POST['id_stage'],$_POST['nom'],$_POST['lieu'],$_POST['dates'],$_POST['formateur'],$_POST['programme']);
	$stageC->modifierstage($stage1,$_POST['id_stage_ini']);
	echo $_POST['id_stage_ini'];
