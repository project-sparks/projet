...
if (isset($_GET['id_comp'])){
  $competitionC=new competitionC();
    $result=$competitionC->recuperercompetition($_GET['id_comp']);
...
<form method="POST">
          ...
          <div class="main">
            ...
            <input type="number" name="id_comp" value="<?PHP echo $id_comp ?>" hidden>
            <div class="txtb">
              <label>Nom de la Competition :</label>
              <input type="text" name="nom" value="<?PHP echo $nom ?>">
            </div>

            <div class="txtb">
              <label>Nombre des participants</label>
              <input type="number" name="nbre" value="<?PHP echo $nbre ?>">
            </div>


            <div class="txtb">
              <label>Lieu de la Competition :</label>
              <input type="text" name="lieu" value="<?PHP echo $lieu ?>">
            </div>

            <div class="txtb">
              <label>Date de la Competition :</label>
              <input type="date" name="datec" placeholder="Date" value="<?PHP echo $datec ?>">
            </div>
            ...
            <input type="hidden" name="id_comp_ini" value="<?PHP echo $_GET['id_comp'];?>">
          </div>
            </div>
          </div>
</form>
...
if (isset($_POST['modifier'])){
  $competition=new competition($_POST['id_comp'],$_POST['nom'],$_POST['nbre'],$_POST['lieu'],$_POST['datec'],$_POST['descri']);
  $competitionC->modifiercompetition($competition,$_POST['id_comp_ini']);
