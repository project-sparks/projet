						...
						<div class="col-lg-4 cl-md-6">
							<div class="single-training">
								<div class="thumb relative">
									...
									<a onclick="document.getElementById('modal-wrapper').style.display='block'" class="admission-btn">Admission Going on</a>	
								</div>


								<div id="modal-wrapper" class="modal">
								  
								  <form class="modal-content animate" action="/action_page.php" style="height: 600px;width: 600px;">
								    ...
								    <div class="container">
								          ...
								          <div style="background: none;position: absolute;left: 48px;height: 541px;width: 500px;top: 27px;text-align: center;border: 2px solid #f45622; border-radius: 10px;">
								          	<br>
								            <h2 >Commande</h2>
								            <br>
								          	<form method="POST">
