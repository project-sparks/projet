			    	...
			    	<div class="row align-items-center justify-content-center d-flex">
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="ajoutproduitdanspanier.php">produit</a></li>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="events.html"> Upcoming Events</a></p>
						</div>	
					</div>
				</div>
			</section>
			...
			<section class="booking-area section-gap relative" id="consultancy">
				...
				<div  class="container">
					<div  class="row justify-content-between align-items-center">
						...
						<div style="margin: auto;" class="col-lg-4 col-md-6 booking-right">
